...
#FOR TRYING OUT SIS MODEL, THE SAME CODE WOULD WORK IF YOU MODFIY ACCORDINGLY. THE ONLY CHANGE YOU NEED IS SET tmax=20 INSTEAD OF tmax = float('Inf'). THIS DICTATES THE FINISHING TIME AND DOES NOT LOOK FOR AN AUTOMATIC SATURATION. THINK ABOUT WHY THIS IS NEEDED IN SIS.
